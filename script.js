const EVENTS = [
  ...
  },
  {
    ...
    type: ["war","bombing"],
    era: "Recent",
    description: "On February 28, 2026, the United States and Israel launched coordinated military strikes on Iran in what Trump called 'the most powerful military operation in American history.' Codenamed Operation Epic Fury, the opening phase targeted Iran's missile infrastructure, nuclear sites, and senior leadership. Supreme Leader Ayatollah Ali Khamenei, 86, was killed in the opening hours. The U.S. struck over 5,000 targets in the first 10 days, deploying B-2A Spirit stealth bombers, F-35A/C Lightning IIs, F/A-18E/F Super Hornets, F-15E Strike Eagles, Tomahawk cruise missiles, AGM-158 JASSM stand-off missiles, and the combat debut of the Precision Strike Missile (PrSM) and the LUCAS one-way attack drone. On April 1–2, 2026, the U.S. launched 'Phase 2' strikes targeting IRGC command bunkers and hardened underground facilities using GBU-57 Massive Ordnance Penetrators (MOPs) delivered by B-2 bombers. On April 3, Iran responded with its largest single salvo to date — 180+ ballistic missiles aimed at Israel — intercepted at a 94% rate by Israeli Arrow-3 and Iron Dome systems; three Israelis were killed in a strike on Haifa. On April 4, CENTCOM confirmed additional strikes on Bandar Abbas naval staging areas and Fordow fuel enrichment tunnels. On April 5, Iran launched a coordinated salvo of 60+ Fateh-110 ballistic missiles and 200+ Shahed drones targeting Saudi Arabia's Ras Tanura oil terminal — the world's largest crude export facility — causing fires across two storage tank farms; Aramco confirmed partial export disruption. CENTCOM expanded Phase 2 on April 5 with additional B-2 strikes on Isfahan missile production facilities and the Khojir missile complex east of Tehran. Iran's Supreme National Security Council confirmed Mojtaba Khamenei (son of the late Supreme Leader) as acting leadership authority on April 5, formalizing a succession that had been functionally in place since Day 1. On April 6, the U.S. Senate passed a bipartisan War Powers resolution (58–41) demanding the administration seek congressional authorization within 30 days; the White House signaled it would veto. Back-channel diplomatic contacts through Oman were reported by Reuters on April 6 but immediately denied by senior CENTCOM officials. Casualty and damage reporting remains highly contested across all sides. Iran has continued retaliatory missile and drone attacks across the Gulf, targeting U.S.-aligned military and energy infrastructure.",
    stats: {
      usDeaths: "11 killed in action; 380+ wounded (as of April 6, 2026)",
      iranianDeaths: "1,200+ confirmed (Iran Ministry of Health); HRANA est. 8,500+; Trump admin claims 35,000 — all disputed",
      civiliansDead: "Heavily disputed; 18 hospitals struck (WHO); school strike in Minab killed 168+ including schoolgirls; Isfahan dormitory strike killed 108 students; 3 Israelis killed in Haifa (Apr 3); civilian casualties from Ras Tanura attack unclear (Saudi authorities reporting)",
      duration: "Ongoing — launched Feb 28, 2026",
      cost: "$15.8B+ (Pentagon estimate as of April 6, 2026); ongoing",
      targetsStruck: "6,600+ as of April 6, 2026",
      iranianShipsSunk: "55 Iranian naval vessels damaged or destroyed",
      missilesDronesIntercepted: "282 missiles + 833 drones intercepted by Gulf state defenses (first 24 hrs); 180+ ballistic missiles intercepted by Israel Apr 3 (94% kill rate); 60+ Fateh-110 missiles and 200+ drones intercepted near Ras Tanura Apr 5 (partial intercept; fires reported)",
      troopsSent: "11,200+ additional deployed since conflict began; USS Abraham Lincoln + USS Tripoli + USS Carl Vinson strike groups active; USS Dwight D. Eisenhower carrier group ordered to theater (April 6, 2026)",
      aircraftDeployed: "B-2A Spirit (27+ sorties); F-35A/C Lightning II (200+ sorties); F-15E Strike Eagle (270+ sorties); F/A-18E/F Super Hornet (350+ sorties); EA-18G Growler (electronic warfare); MQ-9 Reaper (62 deployed); RQ-4 Global Hawk (ISR); AC-130J Ghostrider (2 sorties, undisclosed targets)",
      ...
      iranAircraftLost: "11 IRIAF fixed-wing aircraft destroyed on ground (incl. 4 Su-24 Fencers, 3 F-4E Phantoms, 2 MiG-29s, 2 F-14 Tomcats); 8 helicopters (Mi-171, Bell 214); ~490 Shahed-136 drones destroyed or degraded",
      missilesFired: "BGM-109 Tomahawk cruise missiles: 2,600+ fired (~$1.87M ea. = ~$4.86B); AGM-158 JASSM/JASSM-ER: 380+ (~$1.4M ea. = ~$532M); PrSM (Precision Strike Missile): 140+ (~$1.2M ea. = ~$168M); GBU-57 MOP (bunker buster): 18 dropped (~$3.5M ea. = ~$63M); JDAM-ER: 9,100+ (~$30K ea. = ~$273M); total munitions cost est. ~$5.9B+",
    ...
    keyFacts: [
      ...
      "On April 5, Iran launched 60+ Fateh-110 ballistic missiles and 200+ Shahed drones at Saudi Arabia's Ras Tanura oil terminal; fires reported across two tank farms; Saudi Aramco confirmed partial export disruption",
      "On April 5, Phase 2 expanded with B-2 strikes on Isfahan missile production facilities and the Khojir missile complex east of Tehran; 4 additional GBU-57 MOPs deployed",
      "On April 5, Iran's Supreme National Security Council formalized Mojtaba Khamenei (son of the late Supreme Leader) as acting leadership authority",
      "On April 6, the U.S. Senate passed a bipartisan War Powers resolution 58–41 demanding congressional authorization within 30 days; White House signaled veto",
      "On April 6, Reuters reported back-channel Oman contacts between U.S. and Iranian representatives; immediately denied by senior CENTCOM and State Department officials",
      "USS Dwight D. Eisenhower carrier group ordered to the theater on April 6, bringing the total U.S. naval presence to four carrier strike groups"
    ],
    outcome: "ONGOING as of April 6, 2026. Iran struck Saudi Arabia's Ras Tanura oil terminal on April 5 with ballistic missiles and drones — the first direct Iranian attack on Saudi energy infrastructure since the war began — causing fires and partial export disruption. Phase 2 operations expanded to Isfahan missile production and Khojir complex. Mojtaba Khamenei has been confirmed as acting Supreme Leader. The U.S. Senate passed a War Powers resolution 58–41 on April 6 demanding congressional authorization; White House veto expected. Back-channel contacts through Oman reported but denied. Iran's drone capacity has been reduced ~95% per U.S. military claims. Iran's navy has lost 50+ ships. The U.S. has expended an estimated $5.9B+ in precision munitions alone. Total operation cost exceeds $15.8B. The Strait of Hormuz remains technically open but shipping is severely constrained by war-risk insurance and elevated threat levels. Russia has deployed naval assets to the Eastern Mediterranean and is reportedly sharing U.S. military positions with Iran. A fourth U.S. carrier strike group (USS Eisenhower) has been ordered to the theater. The IAEA still cannot verify Iran's nuclear status. Congress has not authorized the operation; War Powers challenges remain active. No verified ceasefire framework has been announced; the final scope, cost, and strategic outcome remain unknown."
  }
];
